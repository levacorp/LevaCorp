...
const routes: Routes = [
  ...
  {
    path: 'informacion-edificio/:argumento',
    loadChildren: './pages/informacion-edificio/informacion-edificio.module#InformacionEdificioPageModule',
    canActivate: [AuthGuardService]
  },
  ...
  {
    path: 'crear-dispositivo/:habitacion/:dispositivo/:dir',
